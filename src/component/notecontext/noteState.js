...
const NoteState = (props) => {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `http://i-notebook-api-three.vercel.app/api/notes/fetchAllNotes`,
        {
          method: "GET",
          headers: {
  ...
  const addNotes = async (value) => {
    ...
    const response = await fetch("http://i-notebook-api-three.vercel.app/api/notes/saveNotes", {
      method: "POST",
      headers: {
  ...
  const deleteNotes = async (id) => {
    const returnVal = await fetch(
      `http://i-notebook-api-three.vercel.app/api/notes/deleteNote/${id}`,
      {
        method: "DELETE",
        headers: {
          "Content-Type": "application/json",
  ...
  const updateNotes = async (id, author, title, description, tag) => {
    ...
    const account = async () => {
      try {
        const response = await fetch("http://i-notebook-api-three.vercel.app/api/auth/Account", {
          method: "get",
          headers: {
            "Content-Type": "application/json",
            "auth-token": token,
    ...
    const response = await fetch("http://i-notebook-api-three.vercel.app/api/notes/editNote", {
      method: "PUT",
      headers: {
        "auth-token": token,
        NoteId: id,
